...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return <a href={`https://wa.me/${phoneNumber}?text=${generateMessage()}`} target="_blank" rel="noopener noreferrer" className={`${baseStyles} ${variantStyles[variant]} ${className}`}>
      <div size={variant === 'fixed' ? 32 : 20} />
